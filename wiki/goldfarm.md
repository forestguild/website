...
4. Поставить аддоны [HandyNotes](https://www.curseforge.com/wow/addons/handynotes) и [HandyNotes DungeonLocations](https://www.curseforge.com/wow/addons/handynotes_dungeonlocations), _чтобы прямо на карте видеть входы во все рейды и их статус (зачищен или нет)_
...
<div class="float-right">{% include elements/author.html name="Akulenokwow" %}</div>
