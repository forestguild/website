...
| Героический | 120 | 305 | 355 | Уже нужен максимальный уровень и ilvl, тоже через поиск подземелий |
| Эпохальный | 120 | 315 | 370 | Попасть только ножками (ЛФГ нет в принципе) |
| Эпохальный+ | 120 | 330 | 375 - 425 | Попасть только ножками с ключом, лучший лут в игре, прогрессивная сложность |
