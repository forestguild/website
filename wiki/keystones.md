...
layout: wiki
author: Этке
description: Гайд по мифик+ (эпохальным+) в WoW 8.0.1 и 8.1. Таблицы лута, различия, уровни наград и другие нюансы простым языком.
---
...
| Сложность | Требуемый уровень | Требуемый уровень вещей (ilvl) | ilvl наград | Заметка |
|-|-|-|
| Нормальный | 110-120 | - | 273 - 340 | Можно сразу в них ходить через поиск подземелий |
| Героический | 120 | 305 | 325 - 355 | Уже нужен максимальный уровень и ilvl, тоже через поиск подземелий |
| Эпохальный | 120 | 315 | 340 - 370 | Попасть только ножками (ЛФГ нет в принципе) |
| Эпохальный+ | 120 | 330 | 375 - 410 | Попасть только ножками с ключом, лучший лут в игре, прогрессивная сложность |
...
В патче 8.1 азеритовые вещи из недельного сундука убрали.

| Уровень ключа | Уровень предметов |
|-|-|-|
| 2 | 385 |
| 3 | 385 |
| 4 | 390 |
