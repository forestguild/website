...
* [Method Dungeon Tools (MDT)](https://www.curseforge.com/wow/addons/method-dungeon-tools) - очень удобный инструмент для планирования прохождения ключей. Кстати, есть и [вариант в браузере](https://keystone.guru)
