...
+ [Способы прокачки репутации](#способы-прокачки-репутации)
    ...
    * [Нападения фракций](#нападения-фракций)
    * [Особое](#особое)
...
**Способы фарма**: [локальные задания](#локальные-задания), [стол заданий](#стол-заданий), [нападения фракций](#нападения-фракций), [островные экспедиции](#островные-экспедиции), [подготовка к фронту](#подготовка-к-фронту), [PvP-события](#pvp-события)
...
**Способы фарма**: [квесты](#квесты), [локальные задания](#локальные-задания), [стол заданий](#стол-заданий), [нападения фракций](#нападения-фракций)
