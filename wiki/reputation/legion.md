...
Это небольшие задания на 5-10 минут, раскиданные по локациям. За выполнения каждого получишь минимум **150** репутации с фракцией и награду, которая указана в самой локалке.

Каждый день появляется "мета-локалка" - Эмиссар фракции (см. в левом нижнем углу карты WoW), при выполнении 3-4 локальных заданий этой фракции ты получишь 1500 репутации с этой фракцией.
